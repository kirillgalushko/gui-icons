...
function r(i, t) {
  return l(), o("svg", n, t[0] || (t[0] = [
    ...
    e("path", { d: "M12 7l4.76 3.45l-1.76 5.55h-6l-1.76 -5.55z" }, null, -1),
    e("path", { d: "M12 7v-4m3 13l2.5 3m-.74 -8.55l3.74 -1.45m-11.44 7.05l-2.56 2.95m.74 -8.55l-3.74 -1.45" }, null, -1)
  ]));
}
const h = { render: r };
export {
