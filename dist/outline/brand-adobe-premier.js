...
function l(i, t) {
  return r(), n("svg", o, t[0] || (t[0] = [
    ...
    e("path", { d: "M7.263 15.79v-3.79m0 0v-3.248c0 -.335 .222 -.541 .542 -.541h1.353a1.895 1.895 0 1 1 0 3.789z" }, null, -1),
    e("path", { d: "M13.895 10.579v1.895m0 0v3.315m0 -3.315c.531 -.709 1.026 -1.592 1.894 -1.832q .22 -.062 .474 -.063" }, null, -1)
  ]));
}
const d = { render: l };
export {
